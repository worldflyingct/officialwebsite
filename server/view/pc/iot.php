...
<div class="tower5">
    <img src="imgs/IoT/dew.png" alt="<?php WebsiteImportantWord ();?>">
</div>
<div class="tower6">
    <p>
        <img src="imgs/IoT/cvbcb.png" alt="<?php WebsiteImportantWord ();?>">
    </p>
</div>
<div class="tower7">
    <img src="imgs/IoT/fbhfd.png" alt="<?php WebsiteImportantWord ();?>">
</div>
<div class="tower8">
    <p>业务案例</p>
    <ul>
        <li>
            ...
            <img src="imgs/IoT/vdf.png" alt="<?php WebsiteImportantWord ();?>">
        </li>
        <li>
            <p>
                <a href="">在线预览</a>
            ...
            <img src="imgs/IoT/gvh.png" alt="<?php WebsiteImportantWord ();?>">
        </li>
        <li>
            <p>
                <a href="">在线预览</a>
            ...
            <img src="imgs/IoT/ww.png" alt="<?php WebsiteImportantWord ();?>">
        </li>
    </ul>
</div>
<div class="tower9">
    <p>服务机构</p>
    <div><img src="imgs/IoT/gf.png" alt="<?php WebsiteImportantWord ();?>"></div>
</div>
