...
<head>
    ...
    <link rel="stylesheet" href="css/phone_nongye.css">
</head>
<body>
<!-- 侧滑导航根容器 -->
    ...
    <div class="mui-inner-wrap">
        ...
        <div class="mui-content mui-scroll-wrapper">
            <div class="mui-scroll">
                <!-- 主界面具体展示内容 -->
                <div class="box1">
                    <img src="imgs/phone/bg9.png" alt="武汉app开发">
                </div>
                <div class="box2">
                    <div class="top">
                        <h3>方案简介</h3>
                    ...
                    <div class="bottom">
                        <h3>功能介绍</h3>
                        <img src="imgs/phone/bg10.png" alt="武汉app开发">
                    </div>
                </div>
                <div class="box3">
                    <img src="imgs/phone/bg11.png" alt="武汉app开发">
                </div>
                <div class="box4">
                    <img src="imgs/phone/bg12.png" alt="武汉app开发">
                    <h3>用户端app以地图的方式对各个控制点进行控制以及查看各个传感器数据。地图可以自定义上传。</h3>
                    <ul>
                        <li>
                            <img src="imgs/phone/wmap.png" alt="武汉app开发">
                            <div>
                                <!-- <h4>1、查看实时环境数据</h4>
                                ...
                                <img src="imgs/phone/bg21.png">
                            </div>
                        </li>
                        <li>
                            <img src="imgs/phone/wgonglu.png" alt="武汉app开发">
                            <div>
                                <!-- <h4>1、摄像机显示</h4>
                                <p>实时获取视频监控，随时查看棚内农作物情况，可以查询历史监控 </p> -->
                                <img src="imgs/phone/bg22.png">
                            </div>
                        </li>
                        <li>
                            <img src="imgs/phone/wwendu.png" alt="武汉app开发">
                            <div>
                                <!-- <h4>1、记录显示 </h4>
                                <p>显示记录采用轮播的方式，旧记录会显示在下方，新记录会显示在上方。</p> -->
                                <img src="imgs/phone/bg23.png">
                            </div>
                        </li>
                    </ul>
                    <div>
                ...
                <div class="box5">
                    <img src="imgs/phone/bg13.png" alt="武汉app开发">
                    <div>
                        <img src="imgs/phone/bg14.png" alt="武汉app开发">
                    </div>
                    <div>
                        <h3>1、权限管理 </h3>
                    ...
                    <div>
                        <img src="imgs/phone/bg15.png" alt="武汉app开发">
                    </div>
                    <div>
                        <h3>1、规则管理 </h3>
                        <p>可对控制器规则进行管理。</p>
